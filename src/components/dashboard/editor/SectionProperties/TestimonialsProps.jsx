  ...
  return (
    <div className='w-full flex flex-col justify-center items-center gap-4'>
      ...
      <div className="grid w-full max-w-sm items-center gap-3">
        <Label htmlFor="primary_heading">Heading</Label>
        <Input name="primary_heading" type={"text"} onChange={handleChange("primaryHeading")} value={section.content.heading || ""} placeholder="Testimonials" />
      </div>
      <div className="grid w-full max-w-sm items-center gap-3">
